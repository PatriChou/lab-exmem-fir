...
progmem.elf: 
	$(LD) $(LDFLAGS) -o progmem.elf ../../../firmware/crt0_vex.S ../../../firmware/isr.c counter_la_fir.c -lm 

progmem_dis.elf:
	$(LD) $(LDFLAGS) -o progmem_dis.elf ../../../firmware/crt0_vex.S ../../../firmware/isr.c counter_la_fir.c -lm
